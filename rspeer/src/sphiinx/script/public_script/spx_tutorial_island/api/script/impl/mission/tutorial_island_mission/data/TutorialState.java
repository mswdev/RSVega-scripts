...
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.worker.DialogueWorker;
...
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.worker.interactables.NpcWorker;
...
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.OpenTab;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.at_start.CharacterSetupWorker;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.account_guide.PollBooth;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.combat_instructor.FightRat;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.combat_instructor.OpenEquipmentStats;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.magic_instructor.CastAirStrike;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.master_chef.MakeDough;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.mining_instructor.SmithDagger;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.CatchShrimp;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.ChopTree;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.CookShrimp;
import sphiinx.script.public_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.LightFire;
