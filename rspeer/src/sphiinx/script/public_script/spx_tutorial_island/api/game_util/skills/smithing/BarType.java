package sphiinx.script.public_script.spx_tutorial_island.api.game_util.skills.smithing;

import sphiinx.script.public_script.spx_tutorial_island.api.game_util.skills.mining.OreType;
...
public enum BarType {
    ...
    public final int required_smithing_level;
    public final boolean is_members;
    public final OreType ingrediant_one;
    public final OreType ingrediant_two;
    public final int ingrediant_one_amount;
    public final int ingrediant_two_amount;
