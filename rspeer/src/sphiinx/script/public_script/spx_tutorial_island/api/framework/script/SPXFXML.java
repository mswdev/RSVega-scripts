package sphiinx.script.public_script.spx_tutorial_island.api.framework.script;
...
public enum SPXFXML {
    ...
    SPX_TEMPLATE("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
            ...
            "\n" +
            "\n" +
            "<VBox fx:controller=\"sphiinx.script.testing.fxml_gui_test.TestFXGUIController\" maxHeight=\"-Infinity\" maxWidth=\"-Infinity\" minHeight=\"-Infinity\" minWidth=\"-Infinity\" prefHeight=\"400.0\" prefWidth=\"300.0\" style=\"-fx-background-color: #1a1818;\" xmlns=\"http://fxui.com/fxui/9.0.1\" xmlns:fx=\"http://fxui.com/fxml/1\">\n" +
            "   <children>\n" +
