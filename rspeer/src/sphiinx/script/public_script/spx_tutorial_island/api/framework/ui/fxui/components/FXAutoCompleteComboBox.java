package sphiinx.script.public_script.spx_tutorial_island.api.framework.ui.fxui.components;
        ...
        comboBox.addEventHandler(KeyEvent.KEY_RELEASED, new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent event) {
                if (event.getCode() == KeyCode.UP) {
                    ...
                    if (selectedIndex > 0) comboBox.getSelectionModel().select(selectedIndex);
