...
public class MeleeRat extends TIWorker {

    public MeleeRat(TIMission mission) {
        super(mission);
    }
    ...
    public void work() {
        ...
        if (mission.interactWithHint(mission.getHintNPC()) && Time.sleepUntil(() -> Players.getLocal().getAnimation() != -1 || Players.getLocal().isMoving(), 3500))
