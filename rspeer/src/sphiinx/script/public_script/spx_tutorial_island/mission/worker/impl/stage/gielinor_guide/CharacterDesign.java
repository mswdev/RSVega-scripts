package sphiinx.script.public_script.spx_tutorial_island.mission.worker.impl.stage.gielinor_guide;
...
public class CharacterDesign extends Worker<TutorialIslandMission> {
