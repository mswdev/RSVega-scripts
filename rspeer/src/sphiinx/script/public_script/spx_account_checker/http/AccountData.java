...
public class AccountData {
    ...
    public static JsonObject getNext() {
        try {
            final Response response = get("https://api.sphiinx.me/rs/accounts/unchecked");
    ...
    public static String getTotal() {
        try {
            final Response response = get("https://api.sphiinx.me/rs/accounts/unchecked/total");
            if (!response.isSuccessful())
                return null;
    ...
    public static boolean putData(AccountDataType data_type, int account_id, RequestBody request_body) {
        ...
        switch (data_type) {
            case GENERAL:
                url = "https://api.sphiinx.me/rs/accounts/" + account_id + "/update";
                break;
            case OSRS:
                url = "https://api.sphiinx.me/rs/accounts/" + account_id + "/osrs/update";
                break;
            case RS3:
                url = "https://api.sphiinx.me/rs/accounts/" + account_id + "/rs3/update";
                break;
        }
