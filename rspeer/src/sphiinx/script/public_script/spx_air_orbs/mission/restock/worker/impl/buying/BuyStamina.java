...
public class BuyStamina extends AirOrbRestockWorker {
    ...
    @Override
    public void work() {
        final int amount_in_bank = (int) Math.round((BankCache.getValue(12625) * 4) + (BankCache.getValue(12627) * 3) + (BankCache.getValue(12629) * 2) + BankCache.getValue(12631) / 4.0);
