...
public class BuyMindRune extends AirOrbRestockWorker {
    ...
    @Override
    public void work() {
        final int amount_in_bank = BankCache.getValue(mind_rune_id);
