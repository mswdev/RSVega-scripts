package org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.data;

import org.rspeer.runetek.api.Varps;
import org.rspeer.runetek.api.component.tab.Tab;
import org.rspeer.runetek.api.movement.position.Position;
import org.script.paid_script.spx_tutorial_island.api.script.framework.worker.Worker;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.TutorialIslandMission;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.HintWorker;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.OpenTab;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.account_guide.PollBooth;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.combat_instructor.FightRat;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.combat_instructor.OpenEquipmentStats;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.magic_instructor.CastAirStrike;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.master_chef.MakeDough;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.mining_instructor.SmithDagger;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.mining_instructor.TempSmeltOreWorker;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.CatchShrimp;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.ChopTree;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.CookShrimp;
import org.script.paid_script.spx_tutorial_island.api.script.impl.mission.tutorial_island_mission.worker.impl.stage.survival_expert.LightFire;
import org.script.paid_script.spx_tutorial_island.api.script.impl.worker.DialogueWorker;
import org.script.paid_script.spx_tutorial_island.api.script.impl.worker.MovementWorker;
import org.script.paid_script.spx_tutorial_island.api.script.impl.worker.interactables.ItemWorker;
import org.script.paid_script.spx_tutorial_island.api.script.impl.worker.interactables.NpcWorker;
